...
const Blog = () => {
    return (
        <div className='mx-10 mt-10'>
         <section className="bg-indigo-600 dark:text-gray-100 rounded-lg">
	<div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
		<h2 className="text-2xl font-semibold sm:text-4xl text-center">Blog</h2>
		<p className="mt-4 mb-8 dark:text-gray-400 text-center">Get Answered about programming</p>
		<div className="space-y-4">
			<details className="w-full border rounded-lg">
				...
				<p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">There are four main types of state you need to properly manage in your React apps:
                Local state. <br />
                Global state. <br />
                Server state. <br />
                URL state.
